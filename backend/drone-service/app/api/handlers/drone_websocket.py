...
from app.models.models import DroneState, DroneStatus, Position, DeliveryStatus
...
class DroneWebSocketHandler:
    def __init__(self, state_repository: StateRepositoryPort, drone_manager: DroneManager, delivery_use_case=None, video_proxy_handler=None):
        self.state_repository = state_repository
        self.drone_manager = drone_manager
        self.connected_drones: dict[str, WebSocket] = {}
        self.ip_to_id: dict[str, str] = {}
        self.delivery_use_case = delivery_use_case
        self.video_proxy_handler = video_proxy_handler
    ...
    async def _process_drone_message(self, drone_id: str, message: str):
        try:
            ...
            if message_type == "heartbeat":
                ...
                await self._handle_video_frame(drone_id, data)
    ...
    async def _handle_video_frame(self, drone_id: str, data: dict):
        if not self.video_proxy_handler:
            return
        ...
        if frame_data:
            await self.video_proxy_handler.broadcast_frame_to_admins(drone_id, frame_data, delivery_id)
