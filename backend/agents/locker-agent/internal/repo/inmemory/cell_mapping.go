...
var (
	ErrNotInitialized = errors.New("cell mapping not initialized")
...
func (r *CellMappingRepo) GetCellUUID(cellNumber int) (uuid.UUID, error) {
	...
	if !exists {
		return uuid.Nil, ErrCellNotFound
	}
...
func (r *CellMappingRepo) GetMapping() *entity.CellMapping {
	...
	return &entity.CellMapping{
		...
		ExternalCells:   r.GetAllExternalCells(),
		InternalCells:   r.GetAllInternalCells(),
