...
def drop_cargo():
    ...
    try:
        ...
        rospy.loginfo("Step 8.1: Closing cargo bay door (0°)")
        set_angle(0)
        rospy.sleep(1)
        
        rospy.loginfo("Step 8.2: Opening cargo bay door (180°)")
        set_angle(180)
        rospy.sleep(2)  
...
navigate_wait(x=0, y=0, z=1.5, frame_id=f'aruco_{target_aruco_id}', speed=0.8, tolerance=0.3)
rospy.sleep(1)
...
if current_pose:
    ...
    rospy.loginfo("Arrival notification published on /drone/delivery/arrived")
else:
...
rospy.loginfo("Backend will send confirmation after verifying locker cell")
...
while not rospy.is_shutdown() and not drop_confirmed:
    ...
    if elapsed > timeout:
        rospy.logerr("Timeout waiting for drop confirmation (60s)")
...
if current_pose:
    ...
    rospy.loginfo(" Drop ready notification published on /drone/delivery/drop_ready")

# ============================================================================
# COMMENTED OUT: Auto-drop after 5 seconds (for future testing)
# ============================================================================
# rospy.loginfo("Waiting 5 seconds before auto-drop...")
# rospy.sleep(5)
# rospy.loginfo("Step 8: Dropping cargo (auto-mode)")
# drop_cargo()
# ============================================================================
