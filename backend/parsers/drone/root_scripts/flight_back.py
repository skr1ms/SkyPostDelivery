...
battery_sub = rospy.Subscriber('/mavros/battery', BatteryState, battery_callback, queue_size=10)
pose_sub = rospy.Subscriber('/mavros/local_position/pose', PoseStamped, pose_callback, queue_size=10)
...
rospy.loginfo(f"Starting return flight to home ArUco {home_aruco_id} at ({home_x}, {home_y})")
...
if current_pose:
    ...
    rospy.loginfo("Published home arrival notification")

rospy.loginfo("Return flight completed, drone at home")
